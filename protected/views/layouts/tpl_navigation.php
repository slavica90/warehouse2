            ...
            <div class="container">
                ...
                <div class="nav-collapse">
                    ...
                    $this->widget('zii.widgets.CMenu', array(
                        ...
                        'encodeLabel' => false,
                        'items' => array(
                            array('label' => 'Дома', 'url' => array('/site/index'), 'linkOptions' => array("data-description" => "Почетна"),),
//				array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
//				array('label'=>'Contact', 'url'=>array('/site/contact')),
                            array('label' => 'Категории', 'url' => array('/category/admin'), 'linkOptions' => array("data-description" => "Листа на категории"),),
                            array('label' => 'Продукти', 'url' => array('/product/admin'), 'linkOptions' => array("data-description" => "Листа на продукти"),),
                            array('label' => 'Фирми', 'url' => array('/firma/admin'), 'linkOptions' => array("data-description" => "Листа на фирми"),),
                            array('label' => 'Корисници', 'url' => array('/user/admin'), 'linkOptions' => array("data-description" => "Листа на корисници"),),
                            array('label' => 'Најави се', 'url' => array('/site/login'), 'visible' => Yii::app()->user->isGuest, 'linkOptions' => array("data-description" => "Најави се овде"),),
                            array('label' => 'Одјави се (' . Yii::app()->user->name . ')', 'url' => array('/site/logout'), 'visible' => !Yii::app()->user->isGuest, 'linkOptions' => array("data-description" => "Одлогирај се"),)
                        ),
                    ));
                    ?>
                </div><!-- mainmenu -->
