...
//				array('label'=>'Contact', 'url'=>array('/site/contact')),
                            array('label' => 'Категории', 'url' => array('/category/index'), 'linkOptions' => array("data-description" => "Почетна"),),
                            array('label' => 'Продукти', 'url' => array('/product/index'), 'linkOptions' => array("data-description" => "Листа на продукти"),),
                            array('label' => 'Фирми', 'url' => array('/firma/index'), 'linkOptions' => array("data-description" => "Листа на фирми"),),
                            array('label' => 'Корисници', 'url' => array('/user/index'), 'linkOptions' => array("data-description" => "Листа на корисници"),),
