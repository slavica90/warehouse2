...
<div class="tab-content">
  <div class="tab-pane active" id="popular">
  	<ul class="list-popular-content  clearfix">
        <li>
        <img src="<?php echo Yii::app()->request->baseUrl;?>/img/blog/small1.jpg" width="65" height="65" alt="Small blog image" class="pull-left" />
        <h5><a href="#" title="Example blog article">How to buy this theme</a></h5>
        <div>this is a summary of the content...</div>
        </li>
        <li>
        <img src="<?php echo Yii::app()->request->baseUrl;?>/img/blog/small2.jpg" width="65" height="65" alt="Small blog image" class="pull-left"/>
        <h5><a href="#" title="Example blog article">Guide to CSS3</a></h5>
        <div>this is a summary of the content...</div>
        </li>
        <li>
        <img src="<?php echo Yii::app()->request->baseUrl;?>/img/blog/small3.jpg" width="65" height="65" alt="Small blog image" class="pull-left"/>
        <h5><a href="#" title="Example blog article">Moved to a new building</a></h5>
        <div>this is a summary of the content...</div>
        </li>
        <li>
        <img src="<?php echo Yii::app()->request->baseUrl;?>/img/blog/small4.jpg" width="65" height="65" alt="Small blog image" class="pull-left"/>
        <h5><a href="#" title="Example blog article">Choose the right theme</a></h5>
        <div>this is a summary of the content...</div>
        </li>
        <li>
        <img src="<?php echo Yii::app()->request->baseUrl;?>/img/blog/small5.jpg" width="65" height="65" alt="Small blog image" class="pull-left" />
