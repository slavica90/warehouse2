	...
	<div class="row-fluid">
     <div class="span9">
        ...
        <div class="span4">
            ...
            <div><img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/social/facebook.png"  alt="Facebook" /> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/social/twitter.png"  alt="Twitter" /> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/social/linkedin.png"  alt="LinkedIn" /> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/social/google.png"  alt="Google+" /> <img src="<?php echo Yii::app()->request->baseUrl;?>/img/icons/social/email.png"  alt="RSS" /></div>
